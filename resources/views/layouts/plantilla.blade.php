            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        {{-- Volquetes --}}
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ request()->is('volquetes*') || request()->is('volquetes-adelantos*') ? 'active' : '' }}"
                            href="#sidebarVolquetes"
                            data-bs-toggle="collapse"
                            role="button"
                            aria-expanded="false"
                            aria-controls="sidebarVolquetes">
                                <i class="ri-bus-2-line"></i>
                                <span data-key="t-volquetes">Volquetes</span>
                            </a>

                            <div class="collapse menu-dropdown" id="sidebarVolquetes">
                                <ul class="nav nav-sm flex-column">

                                    {{-- Volquetes Principal --}}
                                    <li class="nav-item">
                                        <a href="{{ route('volquetes.index') }}"
                                        class="nav-link {{ request()->is('volquetes') || request()->is('volquetes/*') ? 'active' : '' }}">
                                            Volquetes Principal
                                        </a>
                                    </li>

                                    {{-- Adelanto de Volquetes --}}
                                    <li class="nav-item">
                                        <a href="{{ route('volquetes_adelantos.index') }}"
                                        class="nav-link {{ request()->is('volquetes-adelantos*') ? 'active' : '' }}">
                                            Adelanto de Volquetes
                                        </a>
                                    </li>
