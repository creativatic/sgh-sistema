...
<form method="GET" action="{{ route('tisur.index') }}" class="mb-3">
    <div class="row g-2 align-items-center">
        <div class="col-md-4">
            <input
                ...
                name="search"
                class="form-control"
                placeholder="Buscar por N° Ticket, Transportista o Placa Tracto..."
        ...
        @if(request('search'))
            <div class="col-md-2">
                <a href="{{ route('tisur.index') }}" class="btn btn-outline-primary w-100">
